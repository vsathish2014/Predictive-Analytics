...
% Load file
Results_data = readtable('TestCase_Results_OTM_Diff_DS1.xlsx','Sheet',1); 
...
for i = 1:3
 [p(:,i) table(:,:,i) stats(:,:,i)] = anovan(Results_data(:,i+6),{ Results_data(:,3)},...
  'model','full','varnames',{ 'Robot Condition' },'display','off');
...
ColHeader_multComp = {' ',	' ',	'LL Mean Diff',	'Mean Diff',	'UL Mean Diff', 'p-value'};
  stat_print = fullfile('C:\Users\insav3\Predictive Analytics\DataSets\GB 60day -before failure\Results','TestCase_Results_OTM_Diff_DS1.xlsx');
%  
