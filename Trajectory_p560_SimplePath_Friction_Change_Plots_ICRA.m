...
title('Trend: Frictional Torque - Joint configuration 7 ','FontSize', 12);
...
title('Trend: Inertial Torque - Joint configuration 7','FontSize', 12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
qdd_legend = legend('Axis 1','Axis 2','Axis 3','Axis 4','Axis 5','Axis 6');
set(qdd_legend,'FontSize',8);
...
title('Trend: Coriolis Torque- Joint configuration 7','FontSize', 12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
qdd_legend = legend('Axis 1','Axis 2','Axis 3','Axis 4','Axis 5','Axis 6');
set(qdd_legend,'FontSize',8);
...
title('Trend: Gravity Torque - Joint configuration 7','FontSize', 12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
qdd_legend = legend('Axis 1','Axis 2','Axis 3','Axis 4','Axis 5','Axis 6');
set(qdd_legend,'FontSize',8);
...
set(gca,'PlotBoxAspectRatio',[5 2 1])
title('Trend:  Torque - Axis 2 ','FontSize', 12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
...
set(gca,'PlotBoxAspectRatio',[5 2 1])
title('Trend:  Fricitonal Torque - Axis 2 ','FontSize',12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
%qdd_legend = legend('Before Friciton Change','After Friction Change');
set(qdd_legend,'FontSize',8);
...
set(gca,'PlotBoxAspectRatio',[5 2 1])
title('Trend:  Inertial Torque - Axis 2 ','FontSize', 12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
%qdd_legend = legend('Before Friciton Change','After Friction Change');
set(qdd_legend,'FontSize',8);
...
set(gca,'PlotBoxAspectRatio',[5 2 1])
title('Trend:  Coriolis Torque - Axis 2 ','FontSize', 12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
%qdd_legend = legend('Before Friciton Change','After Friction Change');
set(qdd_legend,'FontSize',8);
...
set(gca,'PlotBoxAspectRatio',[5 2 1])
title('Trend:  Gravitational Torque - Axis 2 ','FontSize', 12);
xlabel('Time in minutes','FontSize', 10);
ylabel('Torque (Nm)','FontSize', 10);
%qdd_legend = legend('Before Friciton Change','After Friction Change');
set(qdd_legend,'FontSize',8);
