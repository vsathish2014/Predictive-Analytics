...
% Every 20th hour load change from 2.5 to 3 kg
clear;
clc;
%profile on
mdl_puma560
...
title('Trend: Average Torque with cyclic load change from 2.5 to 5 in every 20th hour','FontSize', 12);
...
qdd_legend = legend('Axis 1','Axis 2','Axis 3','Axis 4','Axis 5','Axis 6');
set(qdd_legend,'FontSize',6);
axis([time(14388)',time(14412)',0,100]);
grid on;
...
qdd_legend = legend('Axis 1','Axis 2','Axis 3','Axis 4','Axis 5','Axis 6');
set(qdd_legend,'FontSize',6);
axis([time(28788)',time(28812)',0,100]);
grid on;
% Draw a line at change in load
 yL = get(gca,'YLim');
...
qdd_legend = legend('Axis 1','Axis 2','Axis 3','Axis 4','Axis 5','Axis 6');
set(qdd_legend,'FontSize',6);
axis([time(43188)',time(43212)',0,100]);
grid on;
% Draw a line at change in load
 yL = get(gca,'YLim');
