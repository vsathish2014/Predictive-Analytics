...
% Forward dynamics - with a robot model (no friction)
    ...
    parfor axis = 1:6
       ...
       %clear y1,y2,y3,y4,y5,y6;
        ...
        y1 = QD(:,1,axis) + nl'.*0.0001*(1/0.5) ;
         y2 = QD(:,2,axis) + nl'.*0.0001*(1/0.5) ;
         y3 = QD(:,3,axis) + nl'.*0.0001*(1/0.5) ;
         y4 = QD(:,4,axis) + nl'.*0.0001*(1/0.5) ;
         y5 = QD(:,5,axis) + nl'.*0.0001*(1/0.5) ;
         y6 = QD(:,6,axis) + nl'.*0.0001*(1/0.5) ;

        QD_mn(:,:,axis) = cat(2,y1,y2,y3,y4,y5,y6);
        
        %clear y1,y2,y3,y4,y5,y6;
        
         y1 = QDD(:,1,axis) + nl'.*0.0001*(1/0.25) ;
         y2 = QDD(:,2,axis) + nl'.*0.0001*(1/0.25) ;
         y3 = QDD(:,3,axis) + nl'.*0.0001*(1/0.25) ;
         y4 = QDD(:,4,axis) + nl'.*0.0001*(1/0.25) ;
         y5 = QDD(:,5,axis) + nl'.*0.0001*(1/0.25) ;
         y6 = QDD(:,6,axis) + nl'.*0.0001*(1/0.25) ;
