...
%Load test case scenarios
  test_slno = readtable('Test_Cases_OTM_Diff_DS8.xlsx','Sheet',2); 
...
for i = 1:n 
    ...
    no_pc_n(i) = no_pc(i); % Number of PCs for model building
...
stat_print = fullfile('C:\Users\insav3\Predictive Analytics\DataSets\GB 60day -before failure\Results', 'TestCase_Results_OTM_Diff_DS8.xlsx');
