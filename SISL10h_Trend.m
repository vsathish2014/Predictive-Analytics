...
% Read the data
         ...
         data =readtable('SSIL10_Trend.xlsx','Sheet',1,'Range','B1:G184');
...
% data = cell2mat(data(:,:));
    ...
    colHeading ={'28534622-Low L10h','22959739-High L10h', '50342120-Low L10h','9273779-High L10h', '46321286-Low L10h',   '24356139-High L10h'}
