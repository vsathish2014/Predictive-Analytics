...
max_tau_1 = max(abs(tau_pn_mn_1(:,1)));
max_tau_2 = max(abs(tau_pn_mn_1(:,2)));
max_tau_3 = max(abs(tau_pn_mn_1(:,3)));
max_tau_4 = max(abs(tau_pn_mn_1(:,4)));
max_tau_5 = max(abs(tau_pn_mn_1(:,5)));
max_tau_6 = max(abs(tau_pn_mn_1(:,6)));
