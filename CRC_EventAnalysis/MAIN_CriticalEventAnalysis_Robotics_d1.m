...
file_list=ls('C:\ABB\4-DM\SIU\BMW\Data Analysis\SplitFiles\*.csv');
...
slice_len=3600; % time slice length in sec - *(10*24);
...
%   end
  ...
  % excel file
  xlswrite('C:\ABB\4-DM\SIU\BMW\Data Analysis\All_backward_CEA_Results_1hourBasket23Sep2015.xlsx',Results_All);